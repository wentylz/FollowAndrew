...
add_action("after_setup_theme", "followandre_theme_support");
...
function followandrew_register_scripts() {
    ...
    wp_enqueue_script('followander-jq',"https://code.jquery.com/jquery-3.4.1.slim.min.js", array(),"3.4.1", true);
    wp_enqueue_script('followander-popper',"https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js", array(),"1.16.0", true);
    wp_enqueue_script('followander-bootsstrap',"https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js", array(),"4.4.1", true);
    wp_enqueue_script('followander-js',get_template_directory_uri()."/assets/js/main.js", array(), '1.0' , true);

}
add_action('wp_enqueue_scripts', 'followandrew_register_scripts');


function followadrew_widget_areas(){
    register_sidebar(
        array(
            'before_title' => '',
            'after_title' => '',
...
add_action( 'widgets_init', 'followadrew_widget_areas')
?>
